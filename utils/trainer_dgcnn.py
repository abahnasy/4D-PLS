        ...
        with torch.no_grad():
            ...
            for batch in val_loader:
                ...
                if loss_type == 'CEloss': 
                    ...
                    print('Validation: Epoch:{0:4d}, loss:{1:2.3f}, iou_mean:{2:2.3f}, accuracy:{3:.3f}'.format(self.epoch, loss.item(), meanIOU, acc*100))
                if loss_type == '4DPLSloss':
